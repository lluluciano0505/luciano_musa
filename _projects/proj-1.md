...
tagline: 'Can spatial data predict home prices well enough to guide housing policy? Building a hedonic model that accounts for neighborhood context and spatial autocorrelation.'
---
